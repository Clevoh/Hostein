...
export default function TopDropdown() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 mt-3 w-52 bg-white shadow-lg rounded-xl py-2 border">
          <Link to="/help" className="block px-4 py-2 hover:bg-gray-100">Help Centre</Link>
          <Link to="/become-host" className="block px-4 py-2 hover:bg-gray-100">Become a host</Link>
